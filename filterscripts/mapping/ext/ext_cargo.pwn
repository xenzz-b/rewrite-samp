...
CreateCargoExt()
{
    ...
    SetDynamicObjectMaterialText(crgoxts, 0, "PARKIR", 90, "Calibri", 50, 1, 0xFFFFFFFF, 0x00000000, 1);
    ...
    SetDynamicObjectMaterialText(crgoxts, 0, "PARKER!!!", 90, "Calibri", 30, 1, 0xFFFFFFFF, 0x00000000, 1);
